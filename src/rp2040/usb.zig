...
pub const buff_status = Register(base_address + 0x58, u32);

pub const buff_cpu_should_handle = Register(base_address + 0x5c, u32);

pub const ep_abort = Register(base_address + 0x60, u32);

pub const ep_abort_done = Register(base_address + 0x64, u32);

pub const ep_stall_arm = Register(base_address + 0x68, u1);
