...
pub const proc_inte = PeripheralRegisterMatrix(2, 4, base_address + 0x100, 0x30, 0x4);
pub const proc_intf = PeripheralRegisterMatrix(2, 4, base_address + 0x110, 0x30, 0x4);
pub const proc_ints = PeripheralRegisterMatrix(2, 4, base_address + 0x120, 0x30, 0x4);

pub const dormant_wake_inte = PeripheralRegisterArray(4, base_address + 0x160, 0x4);
pub const dormant_wake_intf = PeripheralRegisterArray(4, base_address + 0x170, 0x4);
pub const dormant_wake_ints = PeripheralRegisterArray(4, base_address + 0x180, 0x4);
